...
def creat_user_movie_dic(cluster):
    dic={}
    file = "D:\\development\\recommandSystem\\recommandSystem_experience\\movieLens\\测试数据\\测试数据_test_clear.csv"
...
if __name__ == '__main__':
    ...
    for i in range(1,500,1):#用户id  给前50个用户推荐 形成推荐列表
        ...
        outfile="D:\\development\\recommandSystem\\recommandSystem_experience\\movieLens\\测试数据\\T1=100,T2=100_recommend\\user_{}_k邻=30_recommend.xls".format(i)
