...
class Visualization:
    ...
    def visual(self):
        ...
        # w.save("D:\\development\\py_project\\hello_world\\movieLens\\实验数据\\user_Cluster_T1=100,T2=100.xls")
        #w.save("D:\\experiment\\第三次豆瓣\\测试3\\对比实验\\对比实验_K - means聚类结果_K=4.xls")
        w.save("D:\\development\\recommandSystem\\recommandSystem_experience\\movieLens\\测试数据\\对比实验_user_Cluster_T1=100,T2=100.csv")
