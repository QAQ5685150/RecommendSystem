...
data = pd.read_csv("D:\\development\\py_project\\hello_world\\movieLens\\实验数据\\user_category2.csv",encoding='utf-8',header=None,sep = None)
...
zuobiao.to_csv('D:\\development\\py_project\\hello_world\\movieLens\\实验数据\\movieLens_train_zuobiao2.csv', index=False,encoding='utf-8')
